defmodule Resdayn.Codex.Exportable do
  @moduledoc """
  ...
  defmodule AddUpdateAction do
    ...
    def transform(dsl_state) do
      resource_type =
        ...
        |> Resdayn.Codex.Export.Override.ResourceType.resource_to_type()
      ...
      |> Ash.Resource.Builder.add_action(:update, :update,
        ...
        changes: [
          %Ash.Resource.Change{
            change: {Resdayn.Codex.Changes.CreateOverride, resource_type: resource_type},
            on: [:update],
            where: []
          }
        ]
    ...
    def after?(Resdayn.Codex.Importable.AddImportAttributes), do: true
