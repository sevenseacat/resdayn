defmodule Resdayn.Catalog.QuestAnalysis.ItemInvolvement do
  @moduledoc """
  ...
  relationships do
    ...
    belongs_to :object, Resdayn.Catalog.World.ReferencableObject do
      allow_nil? false
    end
  ...
  calculations do
    ...
    calculate :typed_object, :struct, {Resdayn.Catalog.Calculations.TypedObject, field: :object}
  end
